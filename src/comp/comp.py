...
# chars = ['C', 'D', 'E', 'F', 'G'] --> created list in same line
c = [c.name for c in humans if c.name[0] in list(map(chr, range(ord('C'), ord('G')+1))) ]
print(c)
...
f = [(f.name, f.age) for f in humans if f.age in range(27,32+1)]
print(f)
